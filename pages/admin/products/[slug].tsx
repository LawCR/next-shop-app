...
import { ArrowBackIosOutlined, DriveFileRenameOutline, SaveOutlined, UploadOutlined } from '@mui/icons-material';
...
const ProductAdminPage:FC<Props> = ({ product }) => {
    ...
    const onNewTag = (e: React.KeyboardEvent<HTMLDivElement>) => {
        if (e.code === 'Space' && newTagValue.trim() !== '') {
    ...
    const onSubmit = async(form: FormData) => {
        if (form.images.length < 2) return alert('Agregar mínimo 2 imagenes')
        setIsSaving(true)
    ...
    return (
        ...
        >
            ...
            >
                <Box display='flex' justifyContent='end' columnGap={2} sx={{ mb: 1 }}>
                    <Button 
                        color="primary"
